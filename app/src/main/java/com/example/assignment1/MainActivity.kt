...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        boardButtons = arrayOf(
            arrayOf(findViewById(id.button11), findViewById(id.button12), findViewById(id.button13)),
            arrayOf(findViewById(id.button21), findViewById(id.button22), findViewById(id.button23)),
            arrayOf(findViewById(id.button31), findViewById(id.button32), findViewById(id.button33))
        )
